/* I know this should be minified and in a single file, but since this is a portfolio site
   ...
   This module handles the data connection for the About section.
*/

angular.module("App").controller("aboutCtrl", ["$scope", "services", function($scope, services) {
    services.get("about").then(function(data) {
